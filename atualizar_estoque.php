...
<main class="content-area">
    <div id="initial-option" class="content-section active">
        <form id="Edit" enctype="multipart/form-data">
            ...
            <input type="text" id="prod_nm" name="nm_produto" >
            </div>
            <div class="form-group">
                <label for="prod_desc">Descrição:</label>
                <input type="text" id="prod_desc" name="desc_produto" >
            </div>

            <div class="form-group">
                <label for="preco_prod">Preço:</label>
                <input type="number" id="preco_prod" name="prod_preco" step="0.01" min="0" >
            </div>
            <div class="form-group">
                <label for="prod_quant">Quantidade:</label>
                <input type="number" id="prod_quant" name="quant_produto" min="0" >
            </div>

            <div class="form-group">
                <label for="product-packaging">Embalagem:</label>
                <select id="product-packaging" name="embalagem" >
